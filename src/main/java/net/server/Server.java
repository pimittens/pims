...
import net.server.task.ManageBotLoginsTask;
import net.server.task.RankingCommandTask;
import net.server.task.RankingLoginTask;
import net.server.task.RespawnTask;
import net.server.task.UpdateBotsTask;
import net.server.task.UpdateFollowerBotsTask;
...
public class Server {
    ...
    private void initializeTimelyTasks(ChannelDependencies channelDependencies) {
        ...
        tMan.register(new BotLMPQManagerTask(), MINUTES.toMillis(5), MINUTES.toMillis(5));
